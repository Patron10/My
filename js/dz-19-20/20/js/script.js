$(function() {
  ...
  },
  {
    ...
    console.log('massiv skills: ', _.sortBy(_.uniq(_.flatten(_.map(data, 'skills')))));
    console.log('massiv name: ', _.sortBy(_.map(_.orderBy(data, 'friends.length'), 'name')));
    console.log('massiv friend: ', _.uniq(_.map(_.flatten(_.map(data, 'friends')),'name')));
